...
//           {!isMobileView && (
//             <div className="xl:w-80 xl:sticky xl:top-8 xl:h-fit">
//               <div className="floating-card p-6 space-y-8">
...
//                         key={idx}
//                         onClick={() => setSelectedDateIndex(idx)}
//                         className={`filter-button p-4 text-center transition-all duration-300 ${
...
//                         key={cls}
//                         onClick={() => setFilterClass(cls)}
//                         className={`filter-button p-3 font-bold text-sm ${
...
//                       <span className="font-semibold">Show available only</span>
//                     </div>
//                     <input 
//                       type="checkbox"
//                       checked={filterAvailability}
...
//                             : [...prev, type]
//                         )}
//                         className={`filter-button p-3 flex items-center justify-center gap-2 text-sm font-semibold ${
...
//                               : [...prev, slot]
//                           )}
//                           className={`filter-button w-full p-3 flex items-center gap-3 ${
...
//                 {/* Mobile filter content - same as desktop but with mobile-optimized spacing */}
...
//                             setShowMobileFilters(false);
//                           }}
//                           className={`filter-button p-4 text-center ${
//                             idx === selectedDateIndex ? 'active' : ''
//                           }`}
//                         >
//                           <div className="font-bold text-sm">{daysMap[date.getDay()]}</div>
...
//                   {/* Other filters follow same pattern as desktop */}
//                   {/* Class Filter */}
//                   <div>
//                     <h3 className="text-sm font-bold text-gray-800 mb-4">Travel Class</h3>
//                     <div className="grid grid-cols-3 gap-2">
//                       {['all', '2S', 'CC', 'SL', '3A', '2A'].map(cls => (
//                         <button
//                           key={cls}
...
//                   {/* Add other mobile filters here following the same pattern */}
//                 </div>
//               </div>
//             </div>
//           )}
...
//                         }
//                       }}
//                       className={`filter-button px-4 py-2 flex items-center gap-2 ${
...
//                 return (
//                   <div key={train._id} className="train-card overflow-hidden">
...
//                                 <div className="flex items-center gap-2">
//                                   <span className="bg-gradient-to-r from-[#000080] to-blue-600 text-white px-3 py-1 rounded-full text-sm font-bold">
//                                     {train.trainNumber}
//                                   </span>
//                                   <MdVerified className="text-green-500" title="Verified Train" />
//                                 </div>
//                               </div>

//                               {/* Running Days with Modern Design */}
...
//                           <div className="text-center lg:text-right bg-gradient-to-br from-green-50 to-green-100 p-4 rounded-2xl border border-green-200">
//                             <div className="text-sm text-green-700 font-medium">Starting from</div>
...
//                           <button
//                             onClick={() => toggleTrainDetails(train._id)}
//                             className="flex items-center gap-2 text-[#000080] font-semibold hover:text-blue-700 transition-colors"
//                           >
//                             {expandedTrain === train._id ? (
//                               <>
//                                 <FaChevronUp />
...
//                   <button
//                     onClick={() => navigate('/')}
//                     className="border-2 border-[#000080] text-[#000080] px-8 py-3 rounded-xl font-semibold hover:bg-[#000080] hover:text-white transition-all duration-300"
//                   >
//                     New Search
//                   </button>
//                 </div>
